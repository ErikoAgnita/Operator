...
class PDF extends FPDF
{
	...
	function Header()
	{
                ...
                $this->Image(base_url().'assets/images/balaikota_salatiga.jpg', 10, 25,'auto','auto','jpeg');
	...
	function Content($data)
	{
            ...
            $no = 1;
                foreach ($data as $key) {
                        $this->setFont('Arial','',20);
                        $this->setFillColor(255,255,255);	
                        $this->cell(10,100,$no,1,0,'L',1);
                        $this->cell(105,100,$key->nama,1,0,'R',1);
                        $this->cell(30,100,$key->saran,1,0,'L',1);
                        $this->cell(50,100,$key->tanggal_saran,1,1,'L',1);
                        $ya = $ya + $rw;
                        $no++;
                }            
